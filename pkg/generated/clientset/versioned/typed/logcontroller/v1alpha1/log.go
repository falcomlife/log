...
import (
	...
	scheme "k8s.io/log-controller/pkg/generated/clientset/versioned/scheme"
)
...
func newLogs(c *LogcontrollerV1alpha1Client, namespace string) *logs {
	return &logs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *logs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Log, err error) {
	result = &v1alpha1.Log{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logs").
...
func (c *logs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LogList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logs").
...
func (c *logs) Create(ctx context.Context, log *v1alpha1.Log, opts v1.CreateOptions) (result *v1alpha1.Log, err error) {
	result = &v1alpha1.Log{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logs").
...
func (c *logs) Update(ctx context.Context, log *v1alpha1.Log, opts v1.UpdateOptions) (result *v1alpha1.Log, err error) {
	result = &v1alpha1.Log{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logs").
...
func (c *logs) UpdateStatus(ctx context.Context, log *v1alpha1.Log, opts v1.UpdateOptions) (result *v1alpha1.Log, err error) {
	result = &v1alpha1.Log{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logs").
...
func (c *logs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Log, err error) {
	result = &v1alpha1.Log{}

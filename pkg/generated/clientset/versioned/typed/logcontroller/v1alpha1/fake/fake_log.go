...
type FakeLogs struct {
	Fake *FakeLogcontrollerV1alpha1
	ns   string
}

var logsResource = schema.GroupVersionResource{Group: "logcontroller.k8s.io", Version: "v1alpha1", Resource: "logs"}

var logsKind = schema.GroupVersionKind{Group: "logcontroller.k8s.io", Version: "v1alpha1", Kind: "Log"}
